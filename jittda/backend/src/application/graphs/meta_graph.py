...
def build_meta_graph() -> StateGraph:
    ...
    builder.add_node("question_orchestrator", question_orchestrator_node)
    builder.add_node("enhancement_agents", enhancement_agents_node)
    ...
    builder.add_edge("question_orchestrator", "enhancement_agents")

    # Phase 4: quality_gate → 조건부 루프
    builder.add_edge("enhancement_agents", "quality_gate")
