...
function EmptyState() {
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-[--color-border-default] bg-[--color-bg-page] px-6 py-16">
      ...
      <Link
        to="/interview/new"
        className="mt-6 inline-flex items-center gap-2 rounded-lg bg-em-500 px-4 py-2.5 text-sm font-medium text-white shadow-sm transition-all hover:bg-em-600 hover:shadow-md"
      >
    ...
    <div>
      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        {jobs.length > 0 && (
          <Link
            to="/interview/new"
            className="inline-flex items-center gap-2 rounded-lg bg-em-500 px-4 py-2.5 text-sm font-medium text-white shadow-sm transition-all hover:bg-em-600 hover:shadow-md"
          >
            <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
            </svg>
