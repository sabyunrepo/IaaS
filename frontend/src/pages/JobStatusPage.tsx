    ...
    <div className={`flex items-center gap-3 ${isActive ? 'opacity-100' : isCompleted ? 'opacity-70' : 'opacity-40'}`}>
      ...
      {isActive && !isFailed && phase !== 'completed' && (
        <span className="ml-auto">
          <svg className="h-4 w-4 animate-spin text-em-700" fill="none" viewBox="0 0 24 24">
      ...
      <div className="mx-auto max-w-2xl">
        <div className="flex flex-col items-center justify-center py-20">
          <div className="relative">
            <div className="h-16 w-16 animate-spin rounded-full border-4 border-em-200 border-t-em-700"></div>
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="h-8 w-8 rounded-full bg-gradient-to-br from-em-500 to-teal-500"></div>
            </div>
          </div>
