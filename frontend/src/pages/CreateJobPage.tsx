      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        >
          <textarea
            ...
            rows={8}
            className="w-full rounded-lg border border-[--color-border-default] p-4 text-[--color-text-primary] placeholder-[--color-text-tertiary] transition-colors focus:border-[--color-border-accent] focus:outline-none focus:ring-2 focus:ring-em-500/20"
            required
            minLength={50}
          />
          ...
          <div className="mt-4">
            ...
            <div className="relative">
              <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                <svg className="h-5 w-5 text-[--color-text-tertiary]" fill="currentColor" viewBox="0 0 24 24">
              ...
              <input
                ...
                className="w-full rounded-lg border border-[--color-border-default] py-2.5 pl-10 pr-3 text-[--color-text-primary] transition-colors focus:border-[--color-border-accent] focus:outline-none focus:ring-2 focus:ring-em-500/20"
              />
            </div>
