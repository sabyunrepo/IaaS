...
class Settings(BaseSettings):
    ...
    BRIGHTDATA_API_TOKEN: str | None = None   # LinkedIn 프로필 수집용
...
secrets:
  ...
  BRIGHTDATA_API_TOKEN: /copilot/${COPILOT_APPLICATION_NAME}/${COPILOT_ENVIRONMENT_NAME}/secrets/BRIGHTDATA_API_TOKEN
